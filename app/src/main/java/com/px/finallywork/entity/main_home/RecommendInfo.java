...
public class RecommendInfo extends BaseBean {
    ...
    public void bindHolder(SuperViewHolder holder, Context context) {
        TextView textView = holder.findViewById(R.id.recommend_title);
        TextView textView2 = holder.findViewById(R.id.recommend_price);
        ...
        ImageView imageView = holder.findViewById(R.id.recommend_img);
        ...
        holder.setOnClickListener(R.id.main_recommend_info_item, new View.OnClickListener() {
            @Override
    ...
    private void sendGoodInfoToGoodActivity(Context context) {
        Intent intent = new Intent(contexts, GoodsInfoActivity.class);
        //private String coverPrice;
        //    private String figure;
        //    private String name;
        //    private String productId;
    ...
    public int getLayoutId() {
        return R.layout.main_home_recommend_info;
    }
}
