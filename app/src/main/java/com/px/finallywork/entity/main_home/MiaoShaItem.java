...
@Data
public class MiaoShaItem extends BaseBean {
    ...
    public void bindHolder(SuperViewHolder holder, Context context) {
        ...
        TextView textView = holder.findViewById(R.id.sec_info_tx);
        textView.setText("￥"+getCoverPrice());
        TextView textView2 = holder.findViewById(R.id.sec_info_tx2);
        textView2.setText("￥"+getOriginPrice());
        textView2.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);

        this.contexts = context;

        holder.setOnClickListener(R.id.main_home_seckill_info_item, new View.OnClickListener() {
            @Override
        ...
        ImageView imageView = holder.findViewById(R.id.sec_info_img);
    ...
    public int getLayoutId() {
        return R.layout.main_home_seckill_info;
    }
}
