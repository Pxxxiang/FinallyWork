...
public class TypeRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class HotViewHolder extends RecyclerView.ViewHolder {
        ...
        private void sendGoodInfoToGoodActivity(Context context,GoodsBean goodsBean) {
            Intent intent = new Intent(context, GoodsInfoActivity.class);
            intent.putExtra("coverPrice", goodsBean.getCoverPrice());
            intent.putExtra("figure", goodsBean.getFigure());
        ...
        public void setData(final List<TypeBean.ResultBean.HotProductListBean> hot_product_list) {
            for (int i = 0; i < hot_product_list.size(); i++) {
                ...
                //设置图片
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DensityUtil.dip2px(80), DensityUtil.dip2px( 80));
                ...
                Glide.with(mContext)
                        ...
                        .into(imageView);
                //设置距离底部有10个dp
                lp.setMargins(0, 0, 0, DensityUtil.dip2px(10));
                ...
                myLinear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        sendGoodInfoToGoodActivity(mContext,goodsBean);
