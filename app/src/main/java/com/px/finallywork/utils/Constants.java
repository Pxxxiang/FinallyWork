...
public class Constants {
    //https://kdybye-1256403051.cos.ap-guangzhou.myqcloud.com/shopping/img/1432113201786.jpg
    public static final String BASE = "https://www.gleams.xyz";
...
//    public static final String BASE = "http://192.168.191.1:8080";
    ...
    // 请求Json数据基本URL
    public static final String BASE_URL_JSON = BASE+"/mall/json/";

    // 请求图片基本URL
    public static final String BASE_URl_IMAGE = BASE+"/mall/img";
